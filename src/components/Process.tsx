...
export const Process: React.FC = () => {
  const { t } = useLanguage();
  return (
    <section id="process" className="py-12 sm:py-16 pt-20 sm:pt-24 scroll-mt-28 relative z-10">
      <div className="container max-w-[1200px] mx-auto px-3 sm:px-4">
        <div className="text-center mb-10">
          ...
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-black mb-4 bg-gradient-to-r from-[#1355B2] via-[#A88AED] to-[#F5569B] bg-clip-text text-transparent">{t('process_title')}</h2>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            ...
            <div key={num} className={`p-6 sm:p-8 rounded-3xl shadow-2xl ${bg} backdrop-blur-sm relative overflow-hidden`}>
