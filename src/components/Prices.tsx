    ...
    <section id="prices" className="py-16 pt-24 scroll-mt-28 relative z-10">
      <div className="container max-w-[1200px] mx-auto px-4">
        <div className="text-center mb-10">
          ...
          <h2 className="text-4xl md:text-5xl font-black mb-6 bg-gradient-to-r from-[#F5569B] via-[#A88AED] to-[#1355B2] bg-clip-text text-transparent">{t('price_title')}</h2>
          <p className="text-lg md:text-xl text-gray-700 max-w-4xl mx-auto leading-relaxed">{t('price_subtitle')}</p>
        </div>
      </div>
    </section>
  );
