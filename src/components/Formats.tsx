...
export const Formats: React.FC = () => {
  ...
  return (
    <section id="formats" className="py-16 pt-24 scroll-mt-28 relative z-10">
      <div className="container max-w-[1200px] mx-auto px-4">
        <div className="text-center mb-10">
          ...
          <h2 className="text-4xl md:text-5xl font-black mb-4 bg-gradient-to-r from-[#CBD83B] via-[#F5569B] to-[#A88AED] bg-clip-text text-transparent">
            {t('f_title')}
          </h2>
        </div>
